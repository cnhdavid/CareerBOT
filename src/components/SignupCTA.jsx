    ...
    <div className="signup-cta-overlay">
      <div className="signup-cta-modal">
        ...
        <div className="signup-cta-content">
          <h3>💾 Save Your Conversation History</h3>
          <p>Sign up to save your chat history and unlock unlimited messages!</p>
          <div className="signup-cta-benefits">
            <div className="benefit-item">✓ Unlimited messages</div>
            <div className="benefit-item">✓ Save conversation history</div>
            <div className="benefit-item">✓ Personalized career advice</div>
            <div className="benefit-item">✓ CV analysis & feedback</div>
          </div>
